...
- [x] 08-01-PLAN.md — CI versioning + GitHub Release publishing in .github/workflows/ci.yml (CI-VER-01..04)
- [x] 08-02-PLAN.md — Pure SemVer comparator src/semverCompare.ts + vitest spec test/compareVersions.test.ts (UPD-01)
